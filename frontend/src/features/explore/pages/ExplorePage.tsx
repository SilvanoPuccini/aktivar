    ...
    <div className="relative h-[calc(100vh-4rem)] w-full overflow-hidden bg-surface md:h-[calc(100vh-5rem)]">
      ...
      <div className="absolute left-4 right-4 top-4 z-[1000] md:left-8 md:right-8 md:top-6">
        <div className="mx-auto max-w-5xl space-y-4">
          <div className="glass overflow-hidden rounded-md border border-outline-variant/20 px-5 py-5 shadow-[var(--shadow-forest)] md:px-6">
      ...
      <div className="absolute bottom-6 right-4 z-[1000] flex flex-col gap-3 md:bottom-8 md:right-8">
        <button
          ...
          className="glass flex h-14 w-14 items-center justify-center rounded-sm border border-outline-variant/20 text-on-surface shadow-[var(--shadow-soft)] cursor-pointer"
          title="Centrar mapa"
        >
          {isLocating ? (
      ...
      <AnimatePresence>
        {selectedActivity && (
          ...
          >
            <div className="relative mx-auto max-w-xl overflow-hidden rounded-md border border-outline-variant/20 glass shadow-[var(--shadow-forest)]">
              <button
                type="button"
