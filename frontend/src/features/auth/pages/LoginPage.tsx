    ...
    <div className="min-h-screen relative overflow-hidden flex" style={{ backgroundColor: '#0c0f0a' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-4">
            {['Trekking', 'Ciclismo', 'Surf', 'Camping', 'Festivales'].map((tag) => (
              <span
                key={tag}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          {/* Form */}
          <motion.div className="space-y-6" custom={2} variants={fadeUp}>
            {/* Email */}
            <div>
          ...
          <motion.div className="grid grid-cols-2 gap-3" custom={4} variants={fadeUp}>
            <button
              type="button"
              className="flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-surface-container-high/40 border border-outline-variant/15 text-on-surface font-body text-sm font-medium hover:bg-surface-container-high/60 transition-all cursor-pointer"
            >
