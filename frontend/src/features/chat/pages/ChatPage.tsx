...
import { ArrowLeft, Image, MapPin, Send, Wifi, WifiOff } from 'lucide-react';
...
export default function ChatPage() {
  ...
  const handleSend = () => {
    ...
    if (status !== 'connected') {
      toast.error('Chat desconectado. Reintentando…');
      return;
    }
    sendMessage({ type: 'message', message_type: 'text', content: inputValue.trim() });
    setInputValue('');
  };
