...
export default function SearchBar({ value, onChange, placeholder = 'Buscar aventuras…', onFocus, onBlur }: SearchBarProps) {
  return (
    <div className="flex w-full items-center rounded-md border border-outline-variant bg-surface-container-high px-5 py-2.5 shadow-[var(--shadow-soft)] transition-all focus-within:border-primary/50 focus-within:bg-surface-container-highest">
