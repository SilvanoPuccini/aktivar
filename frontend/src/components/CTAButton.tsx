...
export default function CTAButton({
  ...
  const style = variant === 'primary' ? { background: 'linear-gradient(135deg, #ffc56c 0%, #f0a500 100%)', boxShadow: 'var(--shadow-soft)' } : undefined;
  ...
  return (
    <motion.button
      ...
      className={[
        'inline-flex items-center justify-center gap-2 rounded-[1.35rem] font-label font-bold uppercase tracking-[0.18em] transition-all duration-200 cursor-pointer',
        sizeClasses[size],
