...
export default function EmptyState({ icon, title, description, action }: EmptyStateProps) {
  return (
    <div className="editorial-card mx-auto flex max-w-xl flex-col items-start gap-5 rounded-md px-6 py-10 text-left md:px-8">
      {icon && (
        <div className="flex h-16 w-16 items-center justify-center rounded-sm bg-surface-container-high text-primary">
          {icon}
        </div>
      )}
